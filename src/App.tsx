        ...
        <section className="pt-24 pb-16 px-8 md:px-16 bg-gradient-to-br from-light-gray to-white dark:from-light-gray-dark dark:to-background-dark min-h-screen w-full max-w-full">
          <div className="max-w-container mx-auto w-full">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16 animate-slide-up">
              <div className="bg-light-gray dark:bg-light-gray-dark rounded-2xl h-64 md:h-96 flex items-center justify-center overflow-hidden shadow-xl">
                <img src="/pictures/hs.jpg" alt="Fola" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="px-4">
        ...
        <section className="pt-24 pb-16 px-4 sm:px-8 md:px-16 bg-background dark:bg-background-dark min-h-screen w-full">
          <div className="max-w-container mx-auto w-full">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16">
              <div className="bg-light-gray dark:bg-light-gray-dark rounded-2xl h-64 md:h-96 flex items-center justify-center overflow-hidden shadow-xl">
                <img src="/pictures/OGM07789.jpg" alt="Fola" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
        ...
        <section className="pt-24 pb-16 px-4 sm:px-8 md:px-16 bg-background dark:bg-background-dark min-h-screen w-full">
          <div className="max-w-container mx-auto w-full">
            ...
            <div id="speaking" className="mb-24">
              ...
              <div className="mb-12 rounded-2xl overflow-hidden h-64 md:h-96 shadow-xl max-w-4xl mx-auto">
                <img src="/pictures/OGM07828.jpg" alt="Fola Speaking" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
            ...
            <div id="workshops" className="mb-24">
              ...
              <div className="mb-12 rounded-2xl overflow-hidden h-64 md:h-96 shadow-xl max-w-4xl mx-auto">
                <img src="/pictures/OGM07913.jpg" alt="Fola Workshop" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
