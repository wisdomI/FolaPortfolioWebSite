  ...
  return (
    <section className="pt-32 sm:pt-40 pb-16 px-8 md:px-16 bg-background dark:bg-background-dark min-h-screen w-full">
      <div className="max-w-container mx-auto w-full">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary dark:text-primary-light mb-4 md:mb-6 text-center animate-fade-in px-4">Cloud & DevOps Insights</h1>
        <p className="text-xl text-gray-700 dark:text-gray-300 text-center mb-12 max-w-3xl mx-auto">
          Get insights on cloud computing, infrastructure automation, and DevOps best practices — straight to your inbox.
        </p>
        ...
        <div className="relative bg-gray-900 dark:bg-surface-dark rounded-2xl p-12 mb-16 text-center overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 text-white">
            <h2 className="text-4xl font-bold mb-4 flex items-center justify-center gap-3"><EnvelopeIcon className="w-10 h-10" /> Subscribe to Updates</h2>
            <p className="text-lg mb-8 opacity-90">Join other engineers receiving technical deep dives and industry trends.</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-gray-dark rounded-xl p-8 hover:border-primary dark:hover:border-primary-dark transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-2xl font-bold text-primary dark:text-primary-light mb-4">Mastering Kubernetes: A Beginner's Guide</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Understanding the core concepts of container orchestration and how to get started with K8s.
              </p>
            ...
            <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-gray-dark rounded-xl p-8 hover:border-primary dark:hover:border-primary-dark transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-2xl font-bold text-primary dark:text-primary-light mb-4">Automating Infrastructure with Terraform</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Best practices for writing modular, reusable Infrastructure as Code (IaC) using Terraform.
              </p>
              <button className="text-gray-700 dark:text-gray-300 font-semibold hover:text-primary dark:hover:text-primary-light hover:underline flex items-center gap-1 transition-colors">
                Read More <span className="text-xl">→</span>
              </button>
            ...
            <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-gray-dark rounded-xl p-8 hover:border-primary dark:hover:border-primary-dark transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-2xl font-bold text-primary dark:text-primary-light mb-4">CI/CD Pipelines: Best Practices for 2025</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                How to build efficient, secure, and reliable CI/CD pipelines using GitHub Actions and Azure DevOps.
              </p>
              <button className="text-gray-700 dark:text-gray-300 font-semibold hover:text-primary dark:hover:text-primary-light hover:underline flex items-center gap-1 transition-colors">
                Read More <span className="text-xl">→</span>
              </button>
            ...
            <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-gray-dark rounded-xl p-8 hover:border-primary dark:hover:border-primary-dark transition-all duration-300 hover:shadow-md">
              ...
              <h3 className="text-2xl font-bold text-primary dark:text-primary-light mb-4">Securing Your Cloud Environment</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Essential security strategies for AWS and Azure to protect your cloud resources.
              </p>
              <button className="text-gray-700 dark:text-gray-300 font-semibold hover:text-primary dark:hover:text-primary-light hover:underline flex items-center gap-1 transition-colors">
                Read More <span className="text-xl">→</span>
              </button>
        ...
        <div className="bg-light-gray dark:bg-light-gray-dark rounded-2xl p-12 border border-gray-200">
          <h2 className="text-3xl font-bold text-primary dark:text-primary-light mb-8 text-center">What You'll Get</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="flex justify-center mb-4"><LightBulbIcon className="w-12 h-12 text-secondary" /></div>
              <h3 className="text-xl font-bold text-primary dark:text-primary-light mb-2">Technical Deep Dives</h3>
              <p className="text-gray-600 dark:text-gray-300">Detailed breakdowns of complex cloud and DevOps concepts.</p>
            </div>
            <div className="text-center">
              <div className="flex justify-center mb-4"><BookOpenIcon className="w-12 h-12 text-secondary" /></div>
              <h3 className="text-xl font-bold text-primary dark:text-primary-light mb-2">Tool Tutorials</h3>
              <p className="text-gray-600 dark:text-gray-300">Step-by-step guides for tools like Kubernetes, Docker, and Terraform.</p>
            </div>
            <div className="text-center">
              <div className="flex justify-center mb-4"><TargetIcon className="w-12 h-12 text-secondary" /></div>
              <h3 className="text-xl font-bold text-primary dark:text-primary-light mb-2">Industry Trends</h3>
              <p className="text-gray-600 dark:text-gray-300">Stay ahead with the latest news and updates in the tech world.</p>
            </div>
          </div>
        </div>
      </div>
