      ...
      <div className="max-w-container mx-auto w-full">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white dark:bg-surface-dark border border-primary/20 dark:border-border-gray-dark rounded-xl p-8 text-center hover:border-primary transition-colors duration-300">
        ...
        {/* Personal Touch */}
        <div className="bg-light-gray dark:bg-light-gray-dark rounded-2xl p-6 sm:p-8 md:p-12 text-center mb-16 border border-primary/10">
